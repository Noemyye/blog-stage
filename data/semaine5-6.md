...
- le système de **filtrage** dynamique : seules les pages contenant les tags sélectionnés sont affichées.
...
- Grâce à l’outil **v0** (IA générative connectée à shadcn/ui), j’ai pu :
  - générer rapidement les composants visuels,
  - les adapter à mes besoins (structure, couleurs, tailles),
  - gagner énormément de temps d’implémentation.

En **1 journée**, le dashboard était fonctionnel, responsive et intégré dans l’app.  
Une tâche qui m’a permis de **tester une vraie collaboration entre UI components, logique de données, et outil d’assistance par IA**.

---

## 📝 Avancement du blog de stage

Tout au long de ces deux semaines, j’ai continué à travailler sur le développement de ce blog :

- Ajout de nouvelles pages (entreprise, articles…)
- Amélioration du layout général
- Préparation à l’intégration des semaines en Markdown
- Réflexion sur le contenu final (bilan, compétences, portfolio)
...
Même si le volume de tâches était moins dense, ces deux semaines m’ont permis de **travailler sur la profondeur technique**, d’**automatiser**, et de renforcer mes compétences en **interface utilisateur**.
